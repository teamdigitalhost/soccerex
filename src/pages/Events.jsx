...
const RECENT = [
  ...
  },
  {
    ...
    image: '/images/events/events/europe-2025-1.webp',
  ...
  },
  {
    ...
    city: 'Miami, USA',
    image: '/images/events/events/miami-2024-1.webp',
  ...
  },
  {
    ...
    city: 'Johan Cruijff ArenA, Amsterdam',
    image: '/images/events/events/europe-2025-3.webp',
  ...
  },
  {
    ...
    image: '/images/events/events/miami-2023-1.webp',
...
// ═══ SPEAKERS (57) ════════════════════════════════════════════════════════════
const SPEAKERS = [
  { name: 'Gianni Infantino', title: 'FIFA President' },
  { name: 'Javier Tebas', title: 'President, La Liga' },
  { name: 'Victor Montagliani', title: 'President of CONCACAF, Vice President FIFA' },
  { name: 'Don Garber', title: 'MLS Commissioner' },
  { name: 'Alessandro Del Piero', title: 'Italian Former Footballer' },
  { name: 'Philippe Moggio', title: 'General Secretary of the CONCACAF' },
  { name: 'Jorge Mas', title: 'Managing Owner, CF Inter Miami' },
  { name: 'Luigi De Siervo', title: 'CEO, Lega Serie A' },
  { name: 'Romy Gai', title: 'Chief Business Officer, FIFA' },
  { name: 'Juan Sebastián Verón', title: 'Argentine Former Footballer' },
  { name: 'Bora Milutinovic', title: 'Former Manager USMNT' },
  { name: 'Jason Roberts', title: 'Chief Football Development Officer, CONCACAF' },
  { name: 'Gilberto Silva', title: 'Co-Founder, Striver' },
  { name: 'Karina LeBlanc', title: 'General Manager & President of Soccer Operations, Portland Thorns' },
  { name: 'Amanda Vandervort', title: 'President, USL Super League' },
  { name: 'Peter Moore', title: 'Founding Owner, Santa Barbara Sky FC' },
  { name: 'Ronald de Boer', title: 'Ajax, Youth Coach' },
  { name: 'Mikael Silvestre', title: 'CEO, Talent Lyfe' },
  { name: 'Sunday Oliseh', title: 'Former Nigeria International' },
  { name: 'Eni Aluko', title: 'Broadcaster, Club Owner & 130 matches for England' },
  { name: 'Paul Barber OBE', title: 'Chief Executive and Deputy Chairman, Brighton & Hove Albion FC' },
  { name: 'Kate Abdo', title: 'Broadcaster' },
  { name: 'Nedum Onuoha', title: 'Former Premier League Footballer' },
  ...
  { name: 'Thomas Rongen', title: 'Broadcaster' },
  ...
  { name: 'James Johnson', title: 'CEO, Football Australia' },
  { name: 'Kyle Martino', title: 'Founder, Over Under Initiative Goalpher' },
  { name: 'Xavier Asensi', title: 'Chief Business Officer, Inter Miami CF' },
  { name: 'Eddy Cue', title: 'Apple\'s Senior Vice President of Services' },
  { name: 'Irene Carretero', title: 'Human Rights Programme Manager, FIFA' },
  { name: 'Ed Foster-Simeon', title: 'President & CEO, U.S. Soccer Foundation' },
  { name: 'Julie Uhrman', title: 'Co-Founder & President, Angel City' },
  { name: 'Hassan El Kamah', title: 'Commercial Director, CAF' },
  { name: 'Leandro Petersen', title: 'Chief Commercial and Marketing Officer, AFA' },
  { name: 'Rasha Elghorour', title: 'Assistant General Coordinator, CAF' },
  { name: 'Yara Abdalla', title: 'FIFA, Media Ticketing Operations Manager' },
  { name: 'Ruba Sbeah', title: 'MLS' },
  { name: 'Amira Yousif', title: 'Egypt Women\'s National Team Coach' },
  { name: 'Toan Ravenscroft', title: 'Managing Director, M&C Saatchi Sport & Entertainment Amsterdam' },
  { name: 'Giulio Tedeschi', title: 'CEO & Founder, Tedeschi & Partners' },
  { name: 'Corne Groenendijk', title: 'Ajax, Head of International Football' },
  { name: 'Danita Johnson', title: 'President, Business Operations, DC United' },
  { name: 'Guillem Balague', title: 'Broadcaster' },
  { name: 'Jill Ellis', title: 'President, San Diego Wave FC' },
  { name: 'Daniella Levine Cava', title: 'Miami-Dade County Mayor' },
  { name: 'Francis Suarez', title: 'Mayor of Miami' },
  { name: 'Anthony Ferguson', title: 'Director of Player Development in Elite Environments' },
