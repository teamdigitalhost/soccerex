...
const PRESS_RELEASES = {
  'soccerex-europe-amsterdam-may-2026': {
    title: 'Soccerex Europe Returns to Amsterdam in May 2026 at the Johan Cruyff Arena',
    ...
    content: [
      ...
      { type: 'p', text: 'Soccerex, the world\'s leading football business platform, has today confirmed that Soccerex Europe will return to Amsterdam in May 2026, hosted once again at the iconic Johan Cruyff Arena.' },
      ...
      { type: 'p', text: 'The Johan Cruyff Arena once again provides a fitting stage for the event, offering a world-class venue at the intersection of elite sport, technology, and business. Attendees can expect an immersive experience designed to foster meaningful connections, strategic partnerships, and informed debate around the issues shaping football\'s future.' },
      { type: 'quote', text: '"We\'re incredibly excited to be bringing Soccerex Europe back to Amsterdam for a third time. The Johan Cruyff Arena provides an unrivalled setting to host two days of world-class content, high-level networking, and a truly international exhibition."', author: 'Garrett Navia', role: 'Managing Director of Soccerex' },
