    ...
    <div className="event-page theme-miami" style={{ background: '#FFF8F4' }}>
      ...
      <section className="relative overflow-hidden" style={{ background: '#0D1B2A', minHeight: 'min(88vh, 760px)', display: 'flex', alignItems: 'flex-end' }}>
        ...
        <div className="relative z-10" style={{ maxWidth: '1180px', margin: '0 auto', width: '100%', padding: 'clamp(90px,12vw,130px) clamp(24px,5vw,72px) clamp(48px,6vw,72px)' }}>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <InquiryModalButton
              kind="pack-request"
              label="Get the exhibitor pack (PDF)"
              modalTitle="Get the exhibitor pack (PDF)"
              ...
              extraPayload={{
                ...
                interest: 'Exhibitor pack download',
                source: 'miami-2026-exhibitor-pack',
              }}
          ...
          <div className="mt-6">
            <DeadlineBanner variant="exhibit" />
          </div>
      ...
      <section style={{ background: '#FFFFFF', padding: 'clamp(72px,9vw,120px) clamp(24px,5vw,80px)' }}>
        <div style={{ maxWidth: '1080px', margin: '0 auto', textAlign: 'center' }}>
          <p className="miami-kicker miami-kicker--pink">The room you're walking into</p>
          ...
          <p className="miami-body fade-up mx-auto mb-12" style={{ fontSize: '1rem', color: '#3a4a5a', maxWidth: 580, lineHeight: 1.6 }}>
            These are the buyers walking your stand. FIFA, LaLiga, UEFA, MLS, the top clubs, and 81 more leagues, federations, and rightsholders have already confirmed.
          </p>
